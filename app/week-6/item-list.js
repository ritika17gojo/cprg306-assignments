    ...
    return (
        <div className="w-full max-w-4xl mx-auto mt-8">
            <div className="flex justify-center mb-4 space-x-3">
                ...
                className={'relative inline-flex items-center justify-center px-6 py-3 font-semibold rounded-full overflow-hidden group ${sortBy === "name" ? "bg-gradient-to-br from-purple-500 to-pink-500" : "bg-gradient-to-br from-gray-400 to-blue-400"} text-white shadow-lg transition-all duration-300 ease-out hover:from-green-500 haver:to-blue-500 hover: scale-110'} 
                >
